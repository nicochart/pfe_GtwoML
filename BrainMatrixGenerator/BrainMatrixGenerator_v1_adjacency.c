/* Générateur de matrice d'adjacence pour le PageRank correspondant au cerveau */
/*Nicolas HOCHART*/

/*
 Ce générateur génère directement la matrice d'adjacence A
 Ceci pose problème pour le PageRank parallèle : Pour celui-ci, nous avons besoin de générer directement AT (A transposé), pour éviter des opérations mémoires en plus.
 Le générateur sera revu dans une V2.
*/
