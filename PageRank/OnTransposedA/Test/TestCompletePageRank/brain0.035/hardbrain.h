/*Cerveau écrit en dure, avec environs 0.35% de valeurs non nulles, pour faire des PageRank sur une matrice générée avec celui-ci*/
/*Nicolas HOCHART*/
...
Brain get_hard_brain(long n)
{
    ...
    double tmp_probCo1[16] = {/*type 1*/0.0001, 0.0004, 0.0004, 0.0005, 0.0004, 0.0004, 0.0005, 0.0004, /*type 2*/0.0004, 0.0002, 0.0001, 0.0001, 0.0001, 0.00005, 0.0001, 0.00005};
    ...
    double tmp_probCo2[8] = {/*type 1*/0.0004, 0.0001, 0.0004, 0.0005, 0.0004, 0.0004, 0.0005, 0.0004};
    ...
    double tmp_probCo3[16] = {/*type 1*/0.0001, 0.0005, 0.0004, 0.0005, 0.0004, 0.0004, 0.0005, 0.0004, /*type 2*/0.0006, 0.00005, 0.0001, 0.0001, 0.0001, 0.00005, 0.0001, 0.00005};
    ...
    double tmp_probCo4[24] = {/*type 1*/0.0004, 0.0005, 0.0005, 0.0001, 0.0004, 0.0004, 0.0005, 0.0004, /*type 2*/0.0006, 0.0005, 0.0002, 0.0005, 0.0006, 0.0005, 0.00045, 0.0000, /*type 3*/0.0006, 0.00005, 0.0001, 0.0001, 0.0001, 0.00005, 0.0001, 0.00005};
    ...
    double tmp_probCo5[8] = {/*type 1*/0.0004, 0.0004, 0.0004, 0.0005, 0.0001, 0.0004, 0.0005, 0.0004};
    ...
    double tmp_probCo6[8] = {/*type 1*/0.0004, 0.0004, 0.0004, 0.00055, 0.0004, 0.0001, 0.0006, 0.0004};
    ...
    double tmp_probCo7[8] = {/*type 1*/0.0004, 0.0002, 0.0004, 0.0006, 0.0004, 0.0004, 0.00005, 0.0004};
    ...
    double tmp_probCo8[16] = {/*type 1*/0.00005, 0.00005, 0.0001, 0.00005, 0.0002, 0.0001, 0.0001, 0.0005, /*type 2*/0.0004, 0.0005, 0.0004, 0.0006, 0.0004, 0.0004, 0.00005, 0.0001};
