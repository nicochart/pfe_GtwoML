/*PageRank non pondéré parallele utilisant le générateur V3 (Matrice parallèle avec blocks sur les ligne uniquement). Le vecteur résultat n'est pas distribué.*/
/*Nicolas HOCHART*/
